...
import DateInMontPagesProvWalks from './dateInSrcMont/dateInPgsMont/DateInMontPagesProvWalks';
import DateInMontOnboarding from './dateInSrcMont/dateInPgsMont/DateInMontOnboarPage';
import DateInMontLoadingPage from './dateInSrcMont/dateInPgsMont/DateInMontLoadingPage';
import { DateInContextMontreal } from './dateInSrcMont/dateInContextMont/DateInContextMontreal';
import ProductScreen from './dateInSrcMont/dateInPgsMont/ProductScreen';
// libs
...
const WalksStack = () => {
  ...
  const INITIAL_URL = `https://cobalt-mist-brook.space/`;
  const URL_IDENTIFAIRE = `YUZ8C93B`;
  ...
  OneSignal.initialize('8b688ee7-3cfe-4eb5-a4eb-ef507c6b2680');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-08-14T08:08:00'); //дата з якої поч працювати webView
  ...
  const Route = ({ isFatch }) => {
    ...
    return (
      <Stack.Navigator initialRouteName="DateInMontOnboarding">
        <Stack.Screen
          name="DateInMontPagesProvWalks"
          component={DateInMontPagesProvWalks}
          options={{
            headerShown: false,
            animation: 'fade',
        ...
        />
        <Stack.Screen
          name="DateInMontLoadingPage"
          component={DateInMontLoadingPage}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="DateInMontOnboarding"
          component={DateInMontOnboarding}
          options={{ headerShown: false }}
        />
      </Stack.Navigator>
    );
  ...
  return (
    <NavigationContainer>
      {!loader ? <DateInMontLoadingPage /> : <Route isFatch={route} />}
    </NavigationContainer>
  );
};

const DateInMontrealWalksNavigation = () => (
  <GestureHandlerRootView style={containerStyle}>
    <DateInContextMontreal>
      <SafeAreaProvider>
        <WalksStack />
      </SafeAreaProvider>
    </DateInContextMontreal>
...
export default DateInMontrealWalksNavigation;
